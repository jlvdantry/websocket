...
function ADODB_Error_Handler($dbms, $fn, $errno, $errmsg, $p1, $p2, &$thisConnection)
{
	...
	case 'EXECUTE':
		...
		$s = $_SERVER['REMOTE_ADDR']."|$dbms error: [$errno: $errmsg] in $fn(\"$sql\")\n";
		break;
	...
	case 'CONNECT':
		...
		$s = $_SERVER['REMOTE_ADDR']."|$dbms error: [$errno: $errmsg] in $fn($host, '****', '****', $database)\n";
		break;
	default:
		$s = $_SERVER['REMOTE_ADDR']."|$dbms error: [$errno: $errmsg] in $fn($p1, $p2)\n";
		break;
	}
	/*
