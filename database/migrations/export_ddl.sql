...
########################################################
  ...
  DB::statement('ALTER TABLE "CHAT_CONVERSACIONES" ALTER COLUMN "INICIO" SET DEFAULT now();');
  DB::statement('ALTER TABLE "CHAT_CONVERSACIONES" ALTER COLUMN "FIN" SET DEFAULT now();');

  DB::statement('ALTER TABLE "CHAT_MENSAJES_NEW" ALTER COLUMN "SENT" SET DEFAULT now();');
  DB::statement('ALTER TABLE "CHAT_MENSAJES_NEW" ALTER COLUMN "RECEIVED" SET DEFAULT now();');
  DB::statement('ALTER TABLE "CHAT_MENSAJES_NEW" ALTER COLUMN "RECD" SET DEFAULT 0;');
