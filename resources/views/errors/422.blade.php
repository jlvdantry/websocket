    ...
    <div class="col-12">
        <div class="d-flex flex-column flex-md-row justify-content-center">
            <div class="col-12 col-md-3 d-flex flex-column justify-content-center align-items-center">
                <h3 class="mt-5 encabezado-cdmx">422</h3>
            </div>
            <div class="col-12 col-md-6 d-flex flex-column border-left-thin-grey justify-content-center pl-md-4 pl-lg-5">
                <h3 class="error-title mt-5">No podemos procesar tu solicitud</h3>
                <p class="grey-light">
                    {{ $exception instanceof \Throwable ? $exception->getMessage():'La petición incluye un identificador que no es posible procesar'}}
                </p>
