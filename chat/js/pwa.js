    ...
    $('#tuser').focus();
		...
		window.recibirmensaje= function  (resp) {
			    ...
			    Notification.requestPermission(function (permission) {
				    ...
				    try {  document.getElementById('chatAudio2').play(); } catch (e) { };
                           });
                    }else
                                try { document.getElementById('chatAudio').play(); } catch (e) { };
                                if(chatboxtitle!=""){
		...
		window.escribiendo= function(resp){
						...
						setTimeout(function() { $("#msg_escribiendo").hide(); }, 1000);
		}
...
function Crear_Ventana_Cliente(chatboxtitle){
	...
	var cadena= '<div id="header" class="d-flex justify-content-around p-lg-0 align-items-center flex-wrap border-bottom position-sticky" style="background-color: #faf8f8;">'+
    ...
    cadena+='<div class="divchatboxinput col-lg-12 mt-lg-2 p-2 fixed-bottom" style="background-color: #ededed;">'+
            '<div id="msg_escribiendo" name="msg_escribiendo" class="col-12 msg_aviso text-success" style="display:none;">'+chatboxtitle+' esta escribiendo...</div>'+
