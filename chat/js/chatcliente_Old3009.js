...
function dame_chatboxmessage_ope(msg) {
        return '<div class="chatboxmessage d-flex align-items-center justify-content-between col-12 mt-2">'+
                      '<div class="chatboxmessagefrom col-2">'+
                                '<img src="images/311_b.png" class="img-fluid "></img>'+
                      '</div>'+
...
function Crear_Ventana_Cliente(chatboxtitle){
	...
	var cadena= '<div id="header" class="d-flex justify-content-around p-lg-0 align-items-center flex-wrap" style="background-color: #faf8f8;">'+
	                '<div class="chatboxtitle col-lg-12 col-sm-12 d-flex align-items-center mt-1">'+
                              '<div class="col-2 p-0">'+
                                     '<img src="images/311.png" class="img-fluid tresonce">'+
                                     '<img src="images/victoria_chat1.png" class="img-fluid victoria_header">'+
                              ...
                              '</div>'+
			      '<div class="chatboxoptions text-white col-5 btn" style="background-color: #b5131b;">'+
			      ...
			      '</div>'+
                        '</div>'+
	                '<div class="col-lg-12 col-sm-12 d-flex align-items-center mt-1 ">'+
                              '<div class="col-2"></div>'+
                              '<div class="horario ml-3">Horario de atención de 8:00 am a 8:00 pm</div>'+
                        '</div>'+
                        '<br clear="all"/>'+
                     '</div>';
...
function resize() {
        ...
        //console.log('width: '+$(window).width()+' height: '+$(window).height()+' h_columna1='+h_columna1);
        if ($(window).width()<400) { /* checa si es movil */
             h_columna2=h_columna1*3;
             h_columna2=$(window).height()-h_columna1;
        }
