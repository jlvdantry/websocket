    ...
    $.ajax({
		...
		success: function(data){
			if($("#id_conversacion").length){
                ...
                $(".chatboxcontent").append('<div style="color:red;" class="chatboxmessage"><p style="font-weight:bold">La sesi&oacuten fue terminada. Gracias por usar los servicios en linea de '+($("#id_inst").val()==4?'9-1-1 CDMX':'Locatel')+'.</p></span></div>');
                $("body").css("overflow","visible");
