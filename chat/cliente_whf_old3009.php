...
<input id="int_slider" type="hidden">
            <div class="pleca" style="background-color: #f4f6f8 !important;">
               <div class="container mt-1" style="background-color: #f4f6f8 !important;">
			   ...
			   <div class="h-service jumbotron d-flex p-0 m-lg-5 flex-sm-column flex-lg-row flex-column bg-white" style=" border-radius:10px">
                              <div class="columna1 d-flex align-items-center justify-content-center p-2 h3 flex-wrap col-lg-6 mb-0 radius" style="background-color: #b5131b !important;" >
                                <div class="container">
                                  <div class="col-lg-6 mb-3 pinlocatel" >
                                   ...
                                   <div class="col-lg-12 col-sm-12 mb-2 h1 d-flex justify-content-between" >
                                        <span class="text-white font-weight-bold chattexto">Chat</span>
                                        <div class="d-none" data-toggle="tooltip" data-title="Horario de atención en chat: 8 a.m. a 8 p.m.">
                                             <i class="fas fa-question-circle col-2 d-sm-none text-white" ></i>
                                        </div>
                                   </div>
                                   <div class="col-lg-12 col-sm-12 mb-3 logolocatel" >
                                        <img src="images/LogoLOCATEL.png" alt="Logotipos Gobierno Federal y Gobierno de la CDMX" class="img-fluid">
                                   </div>
                                   <div class="col-lg-12 col-sm-12 h4 logolocatel" >
                                        <span class="text-white">Estamos para orientarte</span>
                                   </div>
                                   <div class="col-lg-12 col-sm-12 h6 logolocatel" >
			      ...
			      <!-- <div class="col-lg-6" > -->
				      <div id="div_chat" class=" columna2 col-lg-6 pr-0 pl-0" >
					       ...
					       <h3 id="txt_msg"><br></h3>
					       <div id="form_chat">
                                                        <div class="h5 text-left  font-weight-bold col-12 mb-4 ingresa" style=" font-size: 34px; "> Ingresa tus datos para contactar con un operador Locatel.</div>
							<div class="contact-form" align="center">
								<form role="form">
									  ...
									  <br>
									  <div class="form-group col-lg-12 text-left mb-5">
									   ...
									   <div class="col-lg-12 col-sm-12 h6 " >
										<span class="">Horario de atención de 8:00 am a 8:00 pm</span>
									   </div>
								</form>
							</div><br>
					       </div>
					       <div id="enlazandote" class="d-none col-12 mb-3">
                                                        ...
                                                        <div class="h5 text-left  font-weight-bold col-12 mb-5 ingresa" style=" font-size: 34px; ">Estamos enlazándote con un operador, en un momento te atenderemos.</div>
                                                        <br>
					       </div>
