...
@media (max-width: 576px) {
	...
	.chatboxmessagecontent {
	      font-size: 15px;  border-radius: 20px; background-color: #ededed; white-space: pre-wrap;
	}
                                ...
                                <div class="container">
                                  <div class="col-lg-6 mb-3 pinlocatel" >
                                   ...
                                   <div class="col-lg-12 col-sm-12 mb-2 h1 d-flex justify-content-between" >
                                        ...
                                        <div data-toggle="tooltip" data-title="Horario de atención en chat: 8 a.m. a 8 p.m.">
