...
<input id="int_slider" type="hidden">
		  ...
		  <div class="col-md-11" id="cuadro_chat">
			   <div class="h-service d-flex p-0 pt-lg-0 mt-lg-5 flex-sm-column flex-lg-row flex-column bg-white flex-wrap h-100 mb-0" >
					...
					<div class="container">
                                           <div id="DivPinLocatel" class="mb-lg-1 border-bottom pb-lg-3 pl-4 pr-4 pb-2 pt-2">
						   <div id="PinLocatel" class=" d-flex col-lg-12 " >
							<img src="images/PinLocatel_nva.jpeg" class="float-xl-left img-fluid">
						   </div>
					   ...
					   <div class="col-lg-12 col-sm-12  pt-4 d-flex pl-0 pr-0 align-items-start pt-lg-5"  id="div_tienesdudas">
					      <div class="col-6 p-0 text-lg-center mr-1">
							<img src="images/victoria_chat1.jpeg" class="img-fluid victoria_header"></img>
				              ...
				              <div  class="col-6" >
							<img src="images/tienesdudas.png" class="float-xl-left img-fluid">
					      </div>
					   </div>
					</div>
				      </div>
				      ...
				      <div id="div_chat" class="columna2 col-lg-6 pr-0 pl-0 " >
					       ...
					       <div id="enlazandote" class="d-none col-12 mb-2">
