...
echo '<header>
      <div class="container">
         <div class="row justify-content-between m-1 p-1 align-items-center">
	      <a title="Regresar al inicio" href="cliente.php" class="col-6">
                     <img src="images/Logo_ADIP_CIUDAD.svg" alt="Logotipos Gobierno Federal y Gobierno de la CDMX" class="img-fluid">
              </a>
			   ...
			   <div class="h-service jumbotron">
                              <div class="d-flex align-items-center bg-green justify-content-center p-2 h3 flex-wrap border rounded">
                                   ...
                                   <div class="col-lg-6 col-sm-12 text-right" >
                                        <span class="m-1 ">De 8 a.m. a 8 p.m.</span>
                                   </div>
                              </div>
...
echo '<footer class="footerx">
		...
		<div class="col-lg-6 col-sm-12">
		    ...
		    <p class="label-footer text-right">Tel&eacute;fono de LOCATEL</p>
